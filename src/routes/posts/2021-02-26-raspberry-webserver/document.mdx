...
I was thinking "Why should I pay for a server when I have 2 Raspberry Pi's laying around which can do the smae thing and more as a VPS + they are under my control?". 
And this is exactly what i did. 

Short summary: 

I've been paying a server to host a small API for https://hedlajn.info, but it really does not pay off. I have about 10 users daily and paying 5 euroes a month does not justify me having the server. 
...
A must have tool for things like this! and it is also super user friendly to setup and provides us with extremely well logging. 
