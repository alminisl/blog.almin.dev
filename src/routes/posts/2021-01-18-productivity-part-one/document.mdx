...
Since I do not trust my brain.. at all with keeping important information in a long run, one of the most important things, at least for me, is being able to store things not in my head but somewhere external. Like an external HDD, you offload your brain and store the data in an external place like a Note taking app - calendar or even manual notebooks. I always liked the idea to use digital notebooks and calendars to plan and to store as much data as possible, because I will probably forget it if I try to remember something. 
